(function (e, d) {
  function g(a) {
    a.hasOwnProperty("data-simple-scrollbar") ||
      Object.defineProperty(a, "data-simple-scrollbar", new SimpleScrollbar(a));
  }
  function l(a, b) {
    function c(a) {
      var c = a.pageY - e;
  ...
  function f(a) {
    ...
    "0px" === b.height &&
      "0px" !== b["max-height"] &&
      (a.style.height = b["max-height"]);
  }
  function k() {
    for (
      var a = d.querySelectorAll("*[ss-container]"), b = 0;
      b < a.length;
      b++
    )
      g(a[b]);
  ...
  f.prototype = {
    moveBar: function (a) {
      ...
      var d =
        "rtl" === c.direction
          ? c.target.clientWidth - c.bar.clientWidth + 18
          : -1 * (c.target.clientWidth - c.bar.clientWidth);
      h(function () {
        1 <= c.scrollRatio
          ? c.bar.classList.add("ss-hidden")
          : (c.bar.classList.remove("ss-hidden"),
            (c.bar.style.cssText =
              "height:" +
              Math.max(100 * c.scrollRatio, 10) +
              "%; top:" +
              (c.el.scrollTop / b) * 100 +
              "%;right:" +
              d +
              "px;"));
      });
