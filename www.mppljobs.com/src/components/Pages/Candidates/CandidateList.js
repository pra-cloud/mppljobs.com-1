                  ...
                  <div class="widget">
                    ...
                    <div class="specialism_widget">
                      <div class="simple-checkbox">
                        <p>
                          <input type="checkbox" name="smplechk" id="22" />
                          <label for="22">Last Hour</label>
                        </p>
                        <p>
                          <input type="checkbox" name="smplechk" id="23" />
                          <label for="23">Last 24 hours</label>
                        </p>
                        <p>
                          <input type="checkbox" name="smplechk" id="24" />
                          <label for="24">Last 7 days</label>
                        </p>
                        <p>
                          <input type="checkbox" name="smplechk" id="25" />
                          <label for="25">Last 14 days</label>
                        </p>
                        <p>
                          <input type="checkbox" name="smplechk" id="26" />
                          <label for="26">Last 30 days</label>
                        </p>
                        <p>
                          <input type="checkbox" name="smplechk" id="27" />
                          <label for="27">All</label>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="widget">
                    ...
                    <div class="specialism_widget">
                      <div class="simple-checkbox">
                        ...
                        <p>
                          <input type="checkbox" name="smplechk" id="28" />
                          <label for="28">50k - 60k</label>
                        </p>
                        <p>
                          <input type="checkbox" name="smplechk" id="29" />
                          <label for="29">60k - 70k</label>
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="emply-resume-sec">
                      <div class="emply-resume-list">
                        ...
                        <div class="shortlists">
                          <a href="#" title="">
                            Shortlist <i class="la la-plus"></i>
                          </a>
                        </div>
                      </div>
                      <div class="emply-resume-list">
